...
80100394:	e8 b7 02 00 00       	call   80100650 <cprintf>
  cprintf("\n");
80100399:	c7 04 24 11 73 10 80 	movl   $0x80107311,(%esp)
...
mycpu(void)
{
  ...
  if(readeflags()&FL_IF)
    panic("mycpu called with interrupts enabled\n");
80103666:	c7 04 24 54 73 10 80 	movl   $0x80107354,(%esp)
...
80103e84:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103e88:	c7 04 24 11 73 10 80 	movl   $0x80107311,(%esp)
...
80103eb4:	8b 14 85 7c 73 10 80 	mov    -0x7fef8c84(,%eax,4),%edx
      state = states[p->state];
    else
      state = "???";
...
80103f65:	eb 16                	jmp    80103f7d <cps+0x3d>
80103f67:	90                   	nop
  for(p=ptable.proc; p<&ptable.proc[NPROC]; p++){
	if(p->state==SLEEPING)
...
80103f6b:	74 53                	je     80103fc0 <cps+0x80>
	  cprintf("%s \t %d  \t RUNNING  \t \n",p->name, p->pid);
	else if(p->state==RUNNABLE)
80103f6d:	83 f8 03             	cmp    $0x3,%eax
80103f70:	74 6e                	je     80103fe0 <cps+0xa0>
...
80103f7b:	74 2b                	je     80103fa8 <cps+0x68>
	if(p->state==SLEEPING)
80103f7d:	8b 43 a0             	mov    -0x60(%ebx),%eax
80103f80:	83 f8 02             	cmp    $0x2,%eax
80103f83:	75 e3                	jne    80103f68 <cps+0x28>
	   cprintf("%s \t %d \t SLEEPING \t \n", p->name, p->pid);
...
80103fa5:	75 d6                	jne    80103f7d <cps+0x3d>
80103fa7:	90                   	nop
	else if(p->state==RUNNING)
	  cprintf("%s \t %d  \t RUNNING  \t \n",p->name, p->pid);
	else if(p->state==RUNNABLE)
...
80103fc7:	c7 04 24 fb 72 10 80 	movl   $0x801072fb,(%esp)
80103fce:	89 44 24 08          	mov    %eax,0x8(%esp)
80103fd2:	e8 79 c6 ff ff       	call   80100650 <cprintf>
80103fd7:	eb 99                	jmp    80103f72 <cps+0x32>
...
80103fe7:	c7 04 24 13 73 10 80 	movl   $0x80107313,(%esp)
80103fee:	89 44 24 08          	mov    %eax,0x8(%esp)
80103ff2:	e8 59 c6 ff ff       	call   80100650 <cprintf>
80103ff7:	e9 76 ff ff ff       	jmp    80103f72 <cps+0x32>
...
8010400a:	c7 44 24 04 94 73 10 	movl   $0x80107394,0x4(%esp)
80104011:	80 
...
popcli(void)
{
  ...
  if(--mycpu()->ncli < 0)
    panic("popcli");
8010423a:	c7 04 24 b6 73 10 80 	movl   $0x801073b6,(%esp)
...
popcli(void)
{
  if(readeflags()&FL_IF)
    panic("popcli - interruptible");
80104246:	c7 04 24 9f 73 10 80 	movl   $0x8010739f,(%esp)
...
801042d4:	e8 27 f3 ff ff       	call   80103600 <mycpu>
...
acquire(struct spinlock *lk)
{
  ...
  if(holding(lk))
    panic("acquire");
801042f7:	c7 04 24 bd 73 10 80 	movl   $0x801073bd,(%esp)
...
release(struct spinlock *lk)
{
  if(!holding(lk))
    panic("release");
80104349:	c7 04 24 c5 73 10 80 	movl   $0x801073c5,(%esp)
...
80104766:	c7 04 24 cd 73 10 80 	movl   $0x801073cd,(%esp)
...
{
	return cps();
80105484:	e9 b7 ea ff ff       	jmp    80103f40 <cps>
